...
На основе произведенного исследования можно заключить, что компилятор GCC с флагами -O1 и -mavx2 выдает далеко не самую оптимизированную хеш-таблицу, а также, что при реализации хеш-таблицы крайне важно подобрать подходящий размер массива.
