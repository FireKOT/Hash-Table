...
Из графиков видно, что лучше всего себя показала хеш-функция hashCRC32 и что она наиболее равномерно распределяет входные данные. Среди представленных функций у нее наименьший максимальный размер списка , наибольший минимальный размер списка и наименьшее среднеквадратичное отклонение размеров списков. 
...
Версия                    | Среднее время   | Абсолютный прирост | Относительный прирост
:------------------------:|:---------------:|:------------------:|:--------------------:
Оптимизированный размер   | $$858 \pm 5.9$$ | $$ 2.4 \pm 0.1 $$  |  $$ 2.4 \pm 0.1 $$ 
...
Версия                 | Среднее время   | Абсолютный прирост | Относительный прирост
:---------------------:|:---------------:|:------------------:|:--------------------:
Оптимизированный хеш   | $$543 \pm 5.0$$ | $$ 3.8 \pm 0.13 $$ | $$ 1.21 \pm 0.02 $$ 
...
Версия                 | Среднее время   | Абсолютный прирост | Относительный прирост
:---------------------:|:---------------:|:------------------:|:--------------------:
Оптимизированный хеш   | $$496 \pm 3.3$$ | $$ 4.1 \pm $$ 0.13 | $$ 1.09 \pm 0.02 $$ 
