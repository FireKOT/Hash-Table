...
Версия                    | Среднее время   | Абсолютный прирост | Относительный прирост
:------------------------:|:---------------:|:------------------:|:--------------------:
Оптимизированный размер   | $$858 \pm 5.9$$ | $$ \mp $$    | $$ \mp $$ 
...
Версия                 | Среднее время   | Абсолютный прирост | Относительный прирост
:---------------------:|:---------------:|:------------------:|:--------------------:
Оптимизированный хеш   | $$656 \pm 3.9$$ | $$ \mp $$    | $$ \mp $$ 
...
Версия                 | Среднее время   | Абсолютный прирост | Относительный прирост
:---------------------:|:---------------:|:------------------:|:--------------------:
Оптимизированный хеш   | $$543 \pm 5.0$$ | $$ \mp $$    | $$ \mp $$ 
...
Версия                 | Среднее время   | Абсолютный прирост | Относительный прирост
:---------------------:|:---------------:|:------------------:|:--------------------:
Оптимизированный хеш   | $$496 \pm 3.3$$ | $$ \mp $$    | $$ \mp $$ 
